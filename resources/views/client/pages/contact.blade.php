      ...
      <div class= 'row' style="margin-bottom: 100px; ">
        <!-- <div class="d-none d-sm-block mb-5 pb-4  " style="height:300px"> -->
          ...
          <div class="col-lg-6">
            ...
            <iframe width="100%" height="100%" src="https://www.youtube.com/embed/5Kd6wWGuqYw" title="Đánh giá iPhone 14 Pro sau 3 tuần: Đáng mua hơn cả iPhone 14 Pro Max?" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>            </div>
          </div>
          <script>
            function initMap() {
