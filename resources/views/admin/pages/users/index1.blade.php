                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <a class="badge badge-danger rounded" onclick="return confirm('Xóa mục này?')" href="{{route('deleteUser',$user->id)}}"><i class="mdi mdi-wrench"></i></a>
                        <a class="badge badge-info rounded" onclick="return confirm('Sửa mục này?')" href="{{route('showUser',$user->id)}}"><i class="mdi mdi-delete"></i></a>
                    </td>
                </tr>
                  @endforeach           
                </tbody>
